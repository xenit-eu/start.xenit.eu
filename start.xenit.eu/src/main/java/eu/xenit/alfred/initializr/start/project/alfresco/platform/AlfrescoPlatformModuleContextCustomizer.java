...
public class AlfrescoPlatformModuleContextCustomizer implements SpringContextModelCustomizer<SpringContextModel> {

    public void customize(SpringContextModel contextModel) {
//        module.getSpringContext();
    }
}
